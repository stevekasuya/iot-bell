...
const struct mgos_conf_entry sys_config_schema_[142] = {
  {.type = CONF_TYPE_OBJECT, .key = "", .num_desc = 141},
  ...
  {.type = CONF_TYPE_OBJECT, .key = "debug", .num_desc = 9},
  ...
  {.type = CONF_TYPE_BOOL, .key = "enable", .offset = offsetof(struct sys_config, gcp.enable)},
  {.type = CONF_TYPE_STRING, .key = "project", .offset = offsetof(struct sys_config, gcp.project)},
  {.type = CONF_TYPE_STRING, .key = "region", .offset = offsetof(struct sys_config, gcp.region)},
  {.type = CONF_TYPE_STRING, .key = "registry", .offset = offsetof(struct sys_config, gcp.registry)},
  {.type = CONF_TYPE_STRING, .key = "device", .offset = offsetof(struct sys_config, gcp.device)},
  {.type = CONF_TYPE_STRING, .key = "key", .offset = offsetof(struct sys_config, gcp.key)},
  {.type = CONF_TYPE_INT, .key = "token_ttl", .offset = offsetof(struct sys_config, gcp.token_ttl)},
